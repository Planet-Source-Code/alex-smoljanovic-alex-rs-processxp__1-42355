...
Begin VB.Form frmSysInfo 
   ...
   Begin VB.PictureBox picSS 
      ...
      Begin VB.Label Label2 
         ...
         Caption         =   "Stopping a service may disable other services from starting..."
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   6
            Charset         =   0
   ...
   Begin VB.PictureBox picBot 
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "The time required to retrieve information about certain devices depends on the device it's self."
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   6
            Charset         =   0
...
On Error Resume Next
 TabStrip_Click
  ...
  End If
   HGrad picSS.hdc, picSS.ScaleHeight, picSS.ScaleWidth, COLOR_ACTIVECAPTION, Black2White, UNEQUALITYFADE
...
Dim Form As Form
 For Each Form In Forms
  If Form.Name <> "frmSysInfo" Then Unload Form
 Next Form
  Unload Me
   End
End Sub
...
On Error Resume Next
Dim objWMI As Object, objItem As Object, itmX As ListItem, tmpCnt&, tmpBuffer$
             ...
             itmX.SubItems(1) = CStr(.Availability)
              ...
              itmX.SubItems(1) = CStr(.AddressWidth)
               ...
               itmX.SubItems(1) = CStr(.CpuStatus)
                ...
                itmX.SubItems(1) = CStr(.CurrentClockSpeed) ' & "MHz"
...
Dim objWMI As Object, objItem As Object, itmX As ListItem, tmpCnt&, tmpBuffer$, Item As Object
 If Len(MultiItem$) = 0 Then lstMultItems.ListItems.Clear
   lstInfo.ListItems.Clear
    ...
    End Select
     lstInfo.Height = 5295: lstInfo.Top = 2160:  cmdStartStop.Visible = False: picSS.Visible = False
End Function
