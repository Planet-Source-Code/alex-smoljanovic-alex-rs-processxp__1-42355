...
'this module contains global memory related application program interface functions/subs and structures
'see frmMain's sub routine tmrMem_Timer for more info...
